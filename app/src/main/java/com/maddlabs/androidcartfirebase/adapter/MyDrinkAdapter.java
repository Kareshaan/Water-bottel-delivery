package com.maddlabs.androidcartfirebase.adapter;
...
import com.maddlabs.androidcartfirebase.R;
...
import com.maddlabs.androidcartfirebase.listener.IRecyclerViewClickListener;
...
public class MyDrinkAdapter extends RecyclerView.Adapter<MyDrinkAdapter.MyDrinkViewHolder> {
    ...
    private void addToCart(DrinkModel drinkModel) {
        DatabaseReference userCart = FirebaseDatabase.getInstance()
                .getReference("Cart")
                .child("UNIQUE_USER_ID"); //user id will be added here
